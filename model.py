...
def create_nice_UNet(x, features_root=16, n_classes=2, is_training=True):
    ...
    net['encode/conv2_1'] = instance_norm(slim.conv2d(net['encode/pool1'], features_root*2, [3, 3], activation_fn=leaky_relu))
    net['encode/conv2_2'] = instance_norm(slim.conv2d(net['encode/conv2_1'], features_root*2, [3, 3], activation_fn=leaky_relu))
    net['encode/pool2'] = slim.max_pool2d(net['encode/conv2_2'], [2, 2])

    net['encode/conv3_1'] = instance_norm(slim.conv2d(net['encode/pool2'], features_root*4, [3, 3], activation_fn=leaky_relu))
    net['encode/conv3_2'] = instance_norm(slim.conv2d(net['encode/conv3_1'], features_root*4, [3, 3], activation_fn=leaky_relu))
    net['encode/pool3'] = slim.max_pool2d(net['encode/conv3_2'], [2, 2])

    net['encode/conv4_1'] = instance_norm(slim.conv2d(net['encode/pool3'], features_root*8, [3, 3], activation_fn=leaky_relu))
    net['encode/conv4_2'] = instance_norm(slim.conv2d(net['encode/conv4_1'], features_root*8, [3, 3], activation_fn=leaky_relu))
    net['encode/pool4'] = slim.max_pool2d(net['encode/conv4_2'], [2, 2])

    net['encode/conv5_1'] = instance_norm(slim.conv2d(net['encode/pool4'], features_root*16, [3, 3], activation_fn=leaky_relu))
    net['encode/conv5_2'] = instance_norm(slim.conv2d(net['encode/conv5_1'], features_root*16, [3, 3], activation_fn=leaky_relu))

    net['decode/up_conv1'] = slim.conv2d_transpose(net['encode/conv5_2'], features_root * 8, 2, stride=2, activation_fn=None, padding='VALID')
    net['decode/concat_c4_u1'] = tf.concat([net['encode/conv4_2'], net['decode/up_conv1']], 3)
    net['decode/conv1_1'] = instance_norm(slim.conv2d(net['decode/concat_c4_u1'], features_root * 8, [3, 3], activation_fn=leaky_relu))
    net['decode/conv1_2'] = instance_norm(slim.conv2d(net['decode/conv1_1'], features_root * 8, [3, 3], activation_fn=leaky_relu))

    net['decode/up_conv2'] = slim.conv2d_transpose(net['decode/conv1_2'], features_root * 4, 2, stride=2, activation_fn=None, padding='VALID')
    net['decode/concat_c3_u2'] = tf.concat([net['encode/conv3_2'], net['decode/up_conv2']], 3)
    net['decode/conv2_1'] = instance_norm(slim.conv2d(net['decode/concat_c3_u2'], features_root * 4, [3, 3], activation_fn=leaky_relu))
    net['decode/conv2_2'] = instance_norm(slim.conv2d(net['decode/conv2_1'], features_root * 4, [3, 3], activation_fn=leaky_relu))

    net['decode/up_conv3'] = slim.conv2d_transpose(net['decode/conv2_2'], features_root * 2, 2, stride=2, activation_fn=None, padding='VALID')
    net['decode/concat_c2_u3'] = tf.concat([net['encode/conv2_2'], net['decode/up_conv3']], 3)
    net['decode/conv3_1'] = instance_norm(slim.conv2d(net['decode/concat_c2_u3'], features_root * 2, [3, 3], activation_fn=leaky_relu))
    net['decode/conv3_2'] = instance_norm(slim.conv2d(net['decode/conv3_1'], features_root * 2, [3, 3], activation_fn=leaky_relu))

    net['decode/up_conv4'] = slim.conv2d_transpose(net['decode/conv3_2'], features_root, 2, stride=2, activation_fn=None, padding='VALID')
    net['decode/concat_c1_u4'] = tf.concat([net['encode/conv1_2'], net['decode/up_conv4']], 3)
    net['decode/conv4_1'] = instance_norm(slim.conv2d(net['decode/concat_c1_u4'], features_root, [3, 3], activation_fn=leaky_relu))
    net['decode/conv4_2'] = instance_norm(slim.conv2d(net['decode/conv4_1'], features_root, [3, 3], activation_fn=leaky_relu))
